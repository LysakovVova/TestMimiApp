...
def init_caves():
    ...
    (15, "Реголитовая шахта «Арес-1»", 4),
    (16, "Полярная станция «КриоМарс»", 4),
    (17, "Базальтовый карьер «Олимп»", 4),
    (18, "Кремниевый экстрактор «Пыльник»", 4),
    (19, "Атмосферная станция «Зевс»", 5),
    (20, "Плавучий переработчик «Гелион»", 5),
    (21, "Вихревой реактор «Буря»", 5),
    (22, "Давильный комплекс «Глубина»", 5),
    (23, "Кольцевая добывающая станция «Ринг-1»", 6),
    (24, "Метановый переработчик «Титан»", 6),
    (25, "Ледяной экстрактор «Энцелад»", 6),
    (26, "Гравитационная шахта «Хронос»", 6),
    (27, "Криостанция «Бирюза»", 7),
    (28, "Газовый коллектор «Ось»", 7),
    (29, "Полярный реактор «Дейтер»", 7),
    (30, "Ледяная платформа «Ураниум»", 7),
    (31, "Глубинная станция «Тритон»", 8),
    (32, "Штормовой коллектор «Синий Вихрь»", 8),
    (33, "Алмазная платформа «Буря-Н»", 8),
    (34, "Плазменный экстрактор «Посейдон»", 8),
    (35, "Криошахта «Харон»", 9),
    (36, "Азотная станция «Никта»", 9),
    (37, "Поясная добывающая база «Край»", 9),
    (38, "Дальняя лаборатория «Метакристалл»", 9),
]
